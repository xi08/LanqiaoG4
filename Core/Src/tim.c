...
void MX_TIM2_Init(void)
{
  ...
  PA15   ------> TIM2_CH1
  */
  GPIO_InitStruct.Pin = R40_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(R40_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE BEGIN TIM2_Init 2 */
    ...
    // LL_TIM_CC_SetUpdate(TIM2, LL_TIM_CCUPDATESOURCE_COMG_ONLY);
...
void MX_TIM3_Init(void)
{
  ...
  PB4   ------> TIM3_CH1
  */
  GPIO_InitStruct.Pin = R39_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(R39_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE BEGIN TIM3_Init 2 */
    ...
    // LL_TIM_CC_SetUpdate(TIM3, LL_TIM_CCUPDATESOURCE_COMG_ONLY);
...
void usDelay(uint32_t t)
{
    while (t--)
    {
        ...
        while (!LL_TIM_IsActiveFlag_UPDATE(TIM17))
            ;
    }
}
