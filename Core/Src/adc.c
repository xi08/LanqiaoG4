...
void MX_ADC1_Init(void)
{
  ...
  PB14   ------> ADC1_IN5
  */
  GPIO_InitStruct.Pin = R38_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(R38_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = MCP407_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(MCP407_GPIO_Port, &GPIO_InitStruct);
...
void MX_ADC2_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(R37_GPIO_Port, &GPIO_InitStruct);
